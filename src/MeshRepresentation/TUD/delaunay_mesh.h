...
class delaunay_mesh : public ta_triangle_mesh
{
public:
	...
	///
	typedef	typename triangle_mesh_type::connectivity_type		connectivity_type;
public:
	/**@name construction*/
	//@{
	...
	virtual void flip_edges_around_vertex_to_validate(unsigned int ci, unsigned int n);
	...
	vertex_insertion_info insert_vertex(unsigned int vi, unsigned int ci_start = 0);
	//@}
};
