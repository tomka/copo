...
class triangle_mesh : public ta_geometry, public ta_connectivity
{
public:
	/// type of geometry
	...
	/// type of coordinates
	typedef typename ta_geometry::coord_type					coord_type;
	/// type of neighbor cycler
	typedef typename ext_corner_connectivity::neighbor_cycler 	neighbor_cycler;
	/// type of corner cycler
	typedef typename ext_corner_connectivity::corner_cycler		corner_cycler;
...
public:
	...
	/// add a triangle with the given corner information, ensure correct orientation
