...
template<int N>
class point_gui : public fltk::Group, public cgv::utils::observer
{
	fltk::FloatInput* inputs[N];
	cgv::utils::observable< cgv::scene::geometry::point<float,N> > *obs;
public:

	point_gui(int x, int y, int w, int h,const char*l, cgv::utils::observable< cgv::scene::geometry::point<float,N> > *o) 
		:fltk::Group(x,y,w,h)
	{
		obs = o;
