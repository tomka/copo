...
template<int N>
class normal_gui : public fltk::Group, public cgv::utils::observer
{
	fltk::FloatInput* inputs[N];
	cgv::utils::observable< cgv::scene::geometry::normal<float,N> > *obs;
public:

	normal_gui(int x, int y, int w, int h,const char*l, cgv::utils::observable< cgv::scene::geometry::normal<float,N> > *o) 
		:fltk::Group(x,y,w,h)
	{
		obs = o;
