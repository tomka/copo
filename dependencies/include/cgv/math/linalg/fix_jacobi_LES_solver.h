...
public:
	...
	fix_jacobi_LES_solver(cgv::math::linalg::fix_sqr_mat<T,N> A, cgv::math::linalg::fix_col_vec<T,N> b)
	{
		this->A=A;
		this->b=b;
		epsilon=0.001f;
	...
	cgv::math::linalg::fix_col_vec<T,N> solve()
	{
		...
		cgv::math::linalg::fix_col_vec<T,N> temp; 
		T normr=1;
		T normb=std::abs(b(0)); 
		for(int i = 1; i < N;i++)
