...
namespace cgv {
	namespace type {
		namespace func {
			...
			struct promote
			{
				static const bool favour_first = Promote::promotion_rank<T1>::rank > Promote::promotion_rank<T2>::rank;
				typedef typename ctrl::if_<cond::bool_type<favour_first>, T1, T2>::type type;
			};
